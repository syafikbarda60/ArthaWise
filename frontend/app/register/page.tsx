...
import { LockOutlined, EmailOutlined, PersonOutlineOutlined, ArrowForward } from "@mui/icons-material";
...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] flex items-center justify-center p-6 relative overflow-hidden">
      {/* Background Orbs */}
      <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-brand-blue/20 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-brand-green/10 rounded-full blur-[120px] pointer-events-none" />
      ...
      >
        <div className="vui-card p-10 backdrop-blur-2xl bg-[#09090b]/80 border border-white/10 rounded-3xl shadow-2xl">
          <div className="flex flex-col items-center mb-10">
            ...
            <h1 className="text-3xl font-black text-white tracking-tighter">Buat Akun</h1>
            <p className="text-zinc-500 text-sm mt-2 font-medium">Mulai kendalikan keuangan Anda hari ini</p>
          </div>
          ...
          <p className="text-center mt-8 text-xs font-medium text-zinc-500">
            Sudah punya akun?{" "}
            <Link href="/login" className="text-brand-blue hover:text-blue-400 font-bold hover:underline transition-colors">
              Masuk di sini
            </Link>
          </p>
        </div>
